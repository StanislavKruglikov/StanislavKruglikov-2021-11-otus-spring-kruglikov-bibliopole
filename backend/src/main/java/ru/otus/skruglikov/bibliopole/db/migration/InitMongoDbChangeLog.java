...
public class InitMongoDbChangeLog {
    ...
    public void insertComment(final CommentRepository commentRepository) {
        commentRepository.saveAll(Arrays.asList(
                ...
                new Comment(null,"Слегка затянуто.",books.get(1)),
                new Comment(null,"Почитать на досуге можно.",books.get(2))
        )).blockLast();
    }
}
